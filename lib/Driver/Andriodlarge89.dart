                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Column(
                            children: [
                              Text("contact 1",style:GoogleFonts.itim(textStyle: TextStyle(
                                          fontSize: 16
                                        ),)),
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Column(
                            children: [
                              Text("Contact 2",style:GoogleFonts.itim(textStyle: TextStyle(
                                          fontSize: 16
                                        ),)),
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Column(
                            children: [
                              Text("Contact 3",style:GoogleFonts.itim(textStyle: TextStyle(
                                          fontSize: 16
                                        ),)),

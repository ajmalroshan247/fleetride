...
class ContactDeatil extends StatefulWidget {
  const ContactDeatil({super.key});

  @override
  State<ContactDeatil> createState() => _ContactDeatilState();
}

class _ContactDeatilState extends State<ContactDeatil> {
  @override

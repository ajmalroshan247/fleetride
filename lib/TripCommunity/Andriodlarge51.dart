...
class TcEvent1 extends StatefulWidget {
  const TcEvent1({super.key});

  @override
  State<TcEvent1> createState() => _TcEvent1State();
}

class _TcEvent1State extends State<TcEvent1> {
  @override
    ...
    body: Column(
      children: [
        Padding(
          ...
          child: Text(" Events 1 ",style:GoogleFonts.itim(textStyle: TextStyle(
          ...
          child: Container(
             ...
             child: Column(
              children: [
                Padding(
          padding: const EdgeInsets.all(15.0),
          child: Text(" Event 2 ",style:GoogleFonts.itim(textStyle: TextStyle(
                                    fontWeight: FontWeight.bold,fontSize: 20
                                  ),)
                                  ),
        ),
